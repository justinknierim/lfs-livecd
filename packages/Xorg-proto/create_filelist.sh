...
HOME=$(pwd)
URL="http://anduin.linuxfromscratch.org/files/BLFS/svn/xorg/proto-7.4.wget"
TMP=$(mktemp -d)
FILE=$(basename $URL)
cd $TMP && wget -q $URL
...
do
	wget -q http://kerrek.linuxfromscratch.org/pub/blfs/conglomeration/Xorg-proto/$file
	echo '' >> filelist
